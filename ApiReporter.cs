...
namespace EndpointAgent.Services
{
    ...
    public class ApiReporter : IApiReporter
    {
        ...
        /// <summary>
        /// /api/device/report endpoint'ine rapor gönderir ve dönen politikayı çözümler.
        /// </summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            // Basit resilience: geçici ağ/server hatalarında 3 deneme.
            const int maxAttempts = 3;
            for (var attempt = 1; attempt <= maxAttempts; attempt++)
            {
                try
                {
                    // Opsiyonel olarak token'ı header üzerinden de gönderiyoruz.
                    ...
                    _logger.LogInformation(
                        "Rapor gönderildi. StatusCode={StatusCode}, Extensions={Count}, Attempt={Attempt}",
                        (int)response.StatusCode,
                        payload.Extensions.Count,
                        attempt);

                    // HTTP 200 OK: JSON body DevicePolicyResponse tipine çözümlenmeye çalışılır.
